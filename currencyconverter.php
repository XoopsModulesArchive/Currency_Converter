...
<script src="jquery-1.3.1.min.js" type="text/javascript"></script>
    <script src="jquery.openPopupWindow.js" type="text/javascript"></script>
...
<p>&nbsp;</p>
<p align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<? echo ''._CURRCONV_IMAGE.''; ?></p>
<center>
<div align="center">
  <center>
<Table border=0 cellpadding=2 cellspacing=0 width="1316" style="border-collapse: collapse" bordercolor="#111111">
<TR><TD align="center" width="596">
  <p align="right"><? echo ''._CURRCONV_VALUE.'</TD>'; ?>
<td align="center" width="712"> 
<p align="left"> <input name="val" type="text" size="7" /></td>
</TR><TR><TD align="center" width="596">
  <p align="right"><? echo ''._CURRCONV_FROM.'</TD>'; ?>
<td align="center" width="712">
<p align="left"><select name="cur_from">
...
<TR><TD align="center" width="596">
 <p align="right"><? echo ''._CURRCONV_TO.'</TD>'; ?>
<TD align="center" width="712">
<p align="left">
<select name="cur_to">
<option value="DZD">Algerian Dinar (DZD)</option>
...
<p align="right">&nbsp;</TD>
  <TD width="656">
<p align="left">
<input name="submit" type="button" value="<? echo ''._CURRCONV_CONVERT.''; ?>" onclick="showDataInput()" /></p>
<p align="left">

<font size="-2"><? echo ''._CURRCONV_YAHOO.''; ?></font><br /><br />



<a id="s1" href="currencyconverter2.php?something=1" title=""><? echo ''._CURRCONV_POPUP.''; ?></a>
...
<center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.danordesign.com/" target="_blank"><font size='-2'><? echo ''._CURRENCY_CONVERTER_BY.''; ?> Danordesign</a>
<?
